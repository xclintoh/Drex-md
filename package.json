{ 
   "name": "DREX-MD", 
   "version": "2.0.0", 
   "description": "WhatsApp Multi Device Super Bot", 
   "main": "index.js", 
   "type": "commonjs", 
   "scripts": { 
     "start": "node index.js" 
 ...
 "ytdl-core": "git+ssh://git@github.com:khlevon/node-ytdl-core.git#v4.11.4-patch.2", 
  ...
  "directories": { 
   ...
   "repository": { 
     "type": "git", 
     "url": "git+https://github.com/xclintoh/Drex-md.git" 
   }, 
   "bugs": { 
     "url": "https://github.com/xclintoh/Drex-md/issues" 
   }, 
   "homepage": "https://github.com/xclintoh/Drex-md#readme" 
     }
